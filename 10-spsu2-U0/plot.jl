...
fig.suptitle(y=1.02, L"U=0.,\; \delta = 0.1, \; \Delta = 0.02")
...
ax[0].plot(ωs, sigma[:, 2], label=L"\Sigma_{11}(\omega)")
ax[0].plot(ωs, sigma[:, 4], label=L"\Sigma_{21}(\omega)")
ax[0].plot(ωs, sigma[:, 5], label=L"\Sigma_{22}(\omega)")

ax[1].plot(ωs, sigmaold[:, 2], label=L"\Sigma_{11}^\mathrm{old}(\omega)")
ax[1].plot(ωs, sigmaold[:, 4], label=L"\Sigma_{21}^\mathrm{old}(\omega)")
ax[1].plot(ωs, sigmaold[:, 5], label=L"\Sigma_{22}^\mathrm{old}(\omega)")
